...
def home():
    st.markdown('<a href="https://dagshub.com/" title="DAGsHub Logo"><img src="https://raw.githubusercontent.com/nirbarazida/YOLOv6/streamlit/assets/logo.png" style="max-width:100%"></a>', unsafe_allow_html=True)
